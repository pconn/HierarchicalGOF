...
message("Sampling posterior of HSMM without time effects")
...
message("Sampling posterior of HSMM *with* time effects")
...
message("Saving posterior output")
